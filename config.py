...
# Сообщения бота
MESSAGES = {
    'welcome': """Добро пожаловать в **Assertive Me**!

Я помогаю формулировать мысли ясно и уверенно, не нарушая чужих и защищая собственные **личные границы**. Ассертивность — это ключ к здоровому и продуктивному общению.

**Как я работаю:**
Моя задача — переформулировать ваши или чьи-то комментарии, предлагая ассертивные варианты. Я фокусируюсь на 'Я-сообщениях' и конструктивном тоне, избегая обвинений.

**Начните прямо сейчас:** просто перешлите мне любое сообщение или напишите свой текст!""",
